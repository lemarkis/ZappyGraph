...
void PauseState::enter()
{
	...
	OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "BackToGameBtn", "Resume", 250);
	OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "BackToMenuBtn", "Disconnect", 250);
	OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "ExitBtn", "Exit", 250);
	//OgreFramework::getSingletonPtr()->m_pTrayMgr->createLabel(OgreBites::TL_NONE, "PauseLbl", "Pause mode", 250);
	Ogre::OverlayElement * title = OgreFramework::getSingletonPtr()->m_pTrayMgr->createLabel(OgreBites::TL_NONE, "PauseLbl", "Pause", 250)->getOverlayElement();
...
void PauseState::buttonHit(OgreBites::Button *button)
{
	...
	{
		OgreFramework::getSingletonPtr()->m_pTrayMgr->showYesNoDialog("Are You sure?", "Do You really want to quit?");
